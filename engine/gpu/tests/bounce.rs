...
const BOUNCE: ShadeSettings = ShadeSettings { sun: true, sky: true, point_sun: false, uniform_sky: false, bounce: true, ..ShadeSettings::NONE };
...
fn one_bounce_equals_the_reference_sample_per_pixel() {
    ...
    let none = ShadeSettings { sun: false, sky: false, point_sun: false, uniform_sky: false, bounce: true, ..ShadeSettings::NONE };
