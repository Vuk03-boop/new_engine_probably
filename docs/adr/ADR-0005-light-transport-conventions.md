...
- **Implementation status (2026-09-25):** CPU reference and tests done (4A record, C1–C5 pass in the cloud session); GPU reference built and compile-checked, its checks (G1–G5) not yet run on the RTX 3050.
